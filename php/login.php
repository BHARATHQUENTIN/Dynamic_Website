...
if (mysqli_connect_errno()) {  // use like  mysqli_connect_errno($db)
    printf('', mysqli_connect_error()); //also  mysqli_connect_error($db)
    exit(1);
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($query->num_rows == 1) {
        ...
        if (password_verify($userPassword, $hashedPassword)) {
            ...
            $redis = new Predis\Client(); // This is unwanted 
            $redisKey = "user";
